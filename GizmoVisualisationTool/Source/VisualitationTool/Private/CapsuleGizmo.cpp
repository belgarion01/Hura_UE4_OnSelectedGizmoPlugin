...
void UCapsuleGizmo::DrawGizmo(FPrimitiveDrawInterface* PDI) const
{
	FVector XAlignement;
	FVector YAlignement;
	FVector ZAlignement;
	...
	DrawWireCapsule(PDI, GetOwner()->GetActorLocation() + Offset, XAlignement, YAlignement, ZAlignement, Color, Radius, Height, NumSide, SDPG_Foreground, Thickness);
}
